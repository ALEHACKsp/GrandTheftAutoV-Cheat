...
namespace VEHICLE
{
	...
	static void _SET_VEHICLE_BOOST_ACTIVE(Vehicle vehicle, BOOL Toggle) { invoke<Void>(0x4A04DE7CAB2739A1, vehicle, Toggle); } // 0x4A04DE7CAB2739A1 0x072F15F2
	...
	static float GET_VEHICLE_MODEL_ESTIMATED_MAX_SPEED(Hash modelHash) { return invoke<float>(0xF417C2502FFFED43, modelHash); } // 0xF417C2502FFFED43 0x8F291C4A
...
namespace SCRIPT
{
	...
	static void TRIGGER_SCRIPT_EVENT(int eventGroup, uint64_t* args, int argCount, int bit) { static auto func = reinterpret_cast<void(*)(int, uint64_t*, int, int)>(Memory::pattern("48 8B C4 48 89 58 08 48 89 68 10 48 89 70 18 48 89 78 20 41 56 48 81 EC ? ? ? ? 45 8B F0 41 8B F9").count(1).get(0).get<void>(0)); func(eventGroup, args, argCount, bit); }
}
...
namespace UI
{
	...
	static int END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT_WITH_CREW_TAG(char* picName1, char* picName2, BOOL flash, int iconType, char* sender, char* subject, float duration, char* clanTag) { return invoke<int>(0x5CBF7BADE20DB93E, picName1, picName2, flash, iconType, sender, subject, duration, clanTag); } // 0x5CBF7BADE20DB93E 0x3E807FE3
...
namespace DLC2
{
	...
	static void ON_ENTER_SP() { invoke<Void>(0xD7C10C4A637992C9); } // 0xD7C10C4A637992C9
	static void ON_ENTER_MP() { invoke<Void>(0x0888C3502DBBEEF5); } // 0x0888C3502DBBEEF5
}
...
namespace SYSTEM
{
	...
	static float TO_FLOAT(Player index) { return invoke<float>(0xBBDA792448DB5A89, index); } // 0xBBDA792448DB5A89 0x67116627
}
